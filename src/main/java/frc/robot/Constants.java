...
public final class Constants {
  ...
  public static final class DrivetrainConstants {
    ...
    public static final class Feedback {
      ...
      /**
       * The ? term for the Ramsete controller.
       *
       * <p>Unit: Seconds.
       */
  ...
  public static final class VisionConstants {
     ...
     * measurements used: 28.5in to screw holes + 1.75in to the camera = 30.25in
     */
     ...
     * measurements used: 34.25 in to screw holes + 1.75in to the camera = 36in
     */
     ...
     * Field measurements used: 8ft 2 1/4in (98.25in)
     */
    public static final double kHeightTarget = Units.inchesToMeters(98.25);
    /**
     * The pitch, in degrees, of the camera in the low shooting mode. Robot measurements used: 18
     * deg arm - 28deg camera = -10deg
     */
    public static final double kPitchCameraLow = -10;
    /**
     * The pitch, in degrees, of the camera in the high shooting mode. Robot measurements used: 31
     * deg arm - 28deg camera = 3deg
     */
